...
MANIFEST_ROOT="${MANIFEST_ROOT:-$ROOT_DIR/datasets/manifests/spacenet-cnn-embedding-smoke}"
RUN_ROOT="${RUN_ROOT:-$ROOT_DIR/artifacts/runs/cnn-embedding-smoke}"
...
echo "CNN embedding smoke test passed."
